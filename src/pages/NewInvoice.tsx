...
import { Plus, Trash2, CalendarIcon, FileText, CalendarRange, Sparkles } from 'lucide-react';
...
function ShiftRow({ shift, index, onChange, onRemove, clientRates }: {
  ...
  clientRates: { rate_name: string; rate_amount: number }[];
}) {
          ...
          <div className="mt-2">
            ...
            <select
              ...
              onChange={e => {
                ...
                onChange(index, { ...shift, rate_name: e.target.value, hourly_rate: rate?.rate_amount || shift.hourly_rate });
              }}
    ...
    days.forEach(day => {
      ...
      matching.forEach(fs => {
        ...
        newShifts.push({
          ...
          hourly_rate: rate ? rate.rate_amount : selectedClient.hourly_rate,
